...
/* 
       ...
       ?1. Награды зависят за встречу от того, с кем ты встречался:
       ?если у него костюм такого же уровня то х1, если меньше уровня 
       ?то тебе х0.5, если выге уровня, то тебе х2
       ?2. Чтобы можно было поставить рейтинг участнику, сделать систему рейтинга
       ?3. Чтобы при улучшениях был быстрее кулдаун
       ?4. Кулдаун между участниками, которые только встретились будет больше, чем обычный
       ?5. Награды за повторную встречу будут меньше, а дальше все меньше и меньше
       ?6. Продумать про вывод средств с контракта, кто и как может выводить
       ?7. Награда тех кто приглашает выше, чем тех кто только откликается
    */
